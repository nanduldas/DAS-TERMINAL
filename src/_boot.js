...
process.on("uncaughtException", e => {
    signale.fatal(e);
    dialog.showErrorBox("DAS-TERMINAL crashed", e.message || "Cannot retrieve error message.");
    if (tty) {
        tty.close();
    }
    if (extraTtys) {
...
signale.start(`Starting DAS-TERMINAL v${app.getVersion()}`);
