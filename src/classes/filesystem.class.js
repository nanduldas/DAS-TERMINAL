            ...
            blockList.forEach((e, blockIndex) => {
                ...
                switch(e.type) {
                    ...
                    case "edex-theme":
                        ...
                        type = "DAS-TERMINAL theme";
                        break;
                    case "edex-kblayout":
                        icon = this.edexIcons.kblayout;
                        type = "DAS-TERMINAL keyboard layout";
                        break;
                    case "edex-settings":
                    case "edex-shortcuts":
                        icon = this.edexIcons.settings;
                        type = "DAS-TERMINAL config file";
                        break;
                    case "system":
                        icon = this.edexIcons.settings;
                        break;
                    case "edex-themesDir":
                        ...
                        type = "DAS-TERMINAL themes folder";
                        break;
                    case "edex-kblayoutsDir":
                        icon = this.edexIcons.kblayoutsDir;
                        type = "DAS-TERMINAL keyboards folder";
                        break;
                    default:
